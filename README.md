...
7. Setup application database `/item_catalog/database_setup.py`
...
14. Run application using `/item-catalog/project.py`

## JSON Endpoints
The following are open to the public:

Catalog JSON: `/menu/JSON`
    - Displays the whole catalog. Categories and all items.

Category Items JSON: `/menu/<int:menu>/item/JSON`
